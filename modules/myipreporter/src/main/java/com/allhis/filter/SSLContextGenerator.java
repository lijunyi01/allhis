...
public class SSLContextGenerator {
    ...
    public SSLContext getSslContext()
    {
        ...
        try
        {
            File keyStoreFile = new File("/appconf/ah_myipreporter/certificates/keystore.jks");
            File trustStoreFile = new File("/appconf/ah_myipreporter/certificates/truststore.jks");
