...
//    private String encodekey;
    ...
    public static PropertyPlaceholderConfigurer propertyPlaceholderConfigurer() {
        ...
        ppc.setLocation(new FileSystemResource("/appconf/ah_myipreporter/app.properties"));
        return ppc;
    }

    @Bean
    public static JoranConfigurator readLogbackPropertyFile(){
        File logbackFile = new File("/appconf/ah_myipreporter/logback.xml");
...
//    }
    ...
    public JavaMailSenderImpl mailSender(){
        ...
        properties.setProperty("mail.smtp.timeout",emailTimeout);
