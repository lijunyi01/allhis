...
public class MysqlLogDao {
    ...
    public void recordLoginFail(int umid,String ip,String platform,int errorCode){
        jdbcTemplate.update("insert into loginfaillog values(?,now(),?,?,?)",umid,ip,platform,errorCode);
    }

    public void recordLoginFail_M(int umid,String ip,String platform,int errorCode){
        jdbcTemplate.update("insert into loginfaillog_m values(?,now(),?,?,?)",umid,ip,platform,errorCode);
    }

    public void recordLoginhistory(int umid,String ip,String platform){
        jdbcTemplate.update("insert into login_history values(?,now(),?,?)",umid,ip,platform);
    }

    public void recordLoginhistory_M(int umid,String ip,String platform){
        jdbcTemplate.update("insert into login_history_m values(?,now(),?,?)",umid,ip,platform);
    }
